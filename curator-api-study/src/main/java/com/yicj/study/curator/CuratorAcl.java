package com.yicj.study.curator;

import java.util.ArrayList;
import java.util.List;

import com.yicj.study.utils.AclUtils;
...
public class CuratorAcl {
	...
	public CuratorAcl() {
		...
		client = CuratorFrameworkFactory.builder().authorization("digest", "yicj:123456".getBytes())
	...
	public static void main(String[] args) throws Exception {
		...
		Id id1 = new Id("digest", AclUtils.getDigestUserPwd("id1:123456"));
		Id id2 = new Id("digest", AclUtils.getDigestUserPwd("id2:123456"));
